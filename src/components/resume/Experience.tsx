...
export default function Experience({ data }: ExperienceProps) {
  return (
    <div className="overflow-x-hidden px-10">
      <Title>
        my <b className="font-semibold">Experience</b>
      </Title>
      <ul className="border-l-2 border-pink-400/40 relative left-6 sm:left-40 space-y-8 pb-10">
        ...
        >
          <i className="text-white h-5 w-5 sm:h-8 sm:w-8">
            <CoperIcon />
          </i>
        </li>
        {data.map((el, index) => (
          ...
          >
            ...
            <div className="w-full">
              ...
              <p className="text-purple-900/70 text-xs sm:text-sm mt-3">
                {el.desc}
              </p>
            </div>
          </li>
