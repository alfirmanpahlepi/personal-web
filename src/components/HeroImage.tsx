...
export default function HeroImage() {
    return (
        <div className="h-full w-full bg-cover flex items-end"
            style={{ backgroundImage: "url(/hero-img.jpg)" }}>
            <ul className="w-full flex justify-evenly mb-3">
                {socialMedias.map((social, i) => (
                    <li key={i} className="group h-12 w-12 relative bg-white border-2 border-white rounded-full overflow-hidden">
